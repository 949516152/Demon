 ...
 * generated in the com.libf.ws.wsdemon1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Send_QNAME = new QName("http://webservice.libf.com/", "send");
    private final static QName _SendResponse_QNAME = new QName("http://webservice.libf.com/", "sendResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.libf.ws.wsdemon1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.libf.com/", name = "send")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.libf.com/", name = "sendResponse")
